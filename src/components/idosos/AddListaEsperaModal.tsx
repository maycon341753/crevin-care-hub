...
interface AddListaEsperaModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}
...
export function AddListaEsperaModal({ isOpen, onClose, onSuccess }: AddListaEsperaModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Verificar se CPF já existe na lista de espera
      ...
      if (existingEspera) {
        toast.error("CPF já cadastrado na lista de espera");
        return;
      }

      // Verificar se CPF já existe na tabela de idosos ativos
      ...
      if (existingIdoso) {
        toast.error("CPF já cadastrado como idoso ativo");
        return;
      }
      ...
      toast.success("Idoso adicionado à lista de espera com sucesso!");
      resetForm();
      onSuccess();
      onClose();
    } catch (error) {
...
export default AddListaEsperaModal;